...
@section('header', 'Listado de Provincias')

@section('content')
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Provincias</h1>
            <p class="text-sm text-slate-500">Gestiona las divisiones territoriales del sistema.</p>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        <td class="px-6 py-4 text-sm font-medium text-slate-400">#{{ $provincia->id }}</td>
                        <td class="px-6 py-4 text-sm font-semibold text-slate-700">{{ $provincia->nombre }}</td>
