            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-header bg-white border-0 py-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <small class="text-muted">Datos registrados de la intervención seleccionada.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="row g-4">
                        ...
                        {{-- Registrado por --}}
                        <div class="col-12">
                            <label class="form-label fw-semibold text-dark">Registrado por</label>
                            <div class="form-control rounded-3 bg-light shadow-sm py-3">
                                {{-- fix: users()->name (no ->nombre) --}}
                                {{ $atencion->users->name ?? 'Sistema' }}
                            </div>
                        </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="mb-0 fw-semibold">
                                Archivos adjuntos
                                <span class="badge bg-secondary rounded-pill ms-1">{{ $adjuntos->count() }}</span>
                            </h6>
                            <small class="text-muted">Documentos vinculados a esta intervención.</small>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">
                                            ...
                                            &middot;
                                            {{ \Carbon\Carbon::parse($adjunto->created_at)->format('d/m/Y') }}
                                            @if($adjunto->subidoPor)
                                                &middot; {{ $adjunto->subidoPor->name }}
                                            @endif
                                        </small>
                                    </div>
                                </div>
