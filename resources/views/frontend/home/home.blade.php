        ...
        <div class="row align-items-center g-4">
            <div class="col-lg-7">
                ...
                <h1 style="font-family:'Plus Jakarta Sans',sans-serif; font-weight:800; font-size:clamp(1.6rem,4vw,2.4rem); color:#0f172a; margin-bottom:0.5rem; line-height:1.2;">
                    Bienvenido,&nbsp;<span style="background:linear-gradient(135deg,#0d92c2,#17a385); -webkit-background-clip:text; -webkit-text-fill-color:transparent;">{{ auth()->user()->name }}</span>&nbsp;👋
                </h1>
...
<div class="container py-4">
    ...
    {{-- SECCIÓN: Atención Primaria --}}
    <div style="display:flex; align-items:center; gap:12px; margin-bottom:1.2rem; margin-top:0.5rem;">
        <div style="width:4px; height:22px; background:linear-gradient(180deg,#0d92c2,#17a385); border-radius:4px; flex-shrink:0;"></div>
        <p style="font-family:'Plus Jakarta Sans',sans-serif; font-size:11px; font-weight:800; text-transform:uppercase; letter-spacing:1.5px; color:#0879a8; margin:0;">Atención Primaria</p>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-6">
            <a href="#" style="text-decoration:none; display:block;">
                <div class="home-card-primary" style="
                    background: white;
                    border-radius: 18px;
                    padding: 24px;
                ...
                " onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 12px 32px rgba(13,146,194,0.16)'"
                   onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 20px rgba(13,146,194,0.08)'">
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:12px;">
                        ...
                        <span style="background:#e6f5fb; color:#0879a8; border:1px solid #b3e0f5; border-radius:40px; padding:4px 12px; font-size:11.5px; font-weight:700;">Alta prioridad</span>
                    </div>
                    <h3 style="font-family:'Plus Jakarta Sans',sans-serif; font-weight:800; font-size:1.25rem; color:#0f172a; margin-bottom:6px;">Recepción de Casos</h3>
                    <p style="color:#536070; font-size:13.5px; font-weight:500; margin:0 0 16px;">Centralización de Prodenya, Mercadería, Bajo Peso y Género. Registro y seguimiento unificado.</p>
                    <div style="display:flex; align-items:center; gap:6px; color:#0d92c2; font-weight:700; font-size:13.5px;">
                        Iniciar toma de caso <i class="bi bi-arrow-right-circle-fill" style="font-size:16px;"></i>
                    </div>
                </div>
            </a>
        </div>
                ...
                " onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 12px 32px rgba(23,163,133,0.16)'"
                   onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 20px rgba(23,163,133,0.08)'">
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:12px;">
                        ...
                        <span style="background:#e8f9f5; color:#0e8a70; border:1px solid #9fe1cb; border-radius:40px; padding:4px 12px; font-size:11.5px; font-weight:700;">
                            <i class="bi bi-check-circle-fill" style="font-size:11px;"></i> Conectado
                        </span>
                    </div>
                    <h3 style="font-family:'Plus Jakarta Sans',sans-serif; font-weight:800; font-size:1.25rem; color:#0f172a; margin-bottom:6px;">Articulación Institucional</h3>
                    <p style="color:#536070; font-size:13.5px; font-weight:500; margin:0 0 16px;">Gestión de redes y coordinación operativa con áreas externas e instituciones aliadas.</p>
                    <div style="display:flex; align-items:center; gap:6px; color:#17a385; font-weight:700; font-size:13.5px;">
                        Ver redes activas <i class="bi bi-arrow-right-circle-fill" style="font-size:16px;"></i>
                    </div>
                </div>
            </a>
        </div>
