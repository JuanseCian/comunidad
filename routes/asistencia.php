...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/asistencia/toggle',  [AsistenciaController::class, 'toggle']) ->name('asistencia.toggle');
    Route::get('/asistencia/historial/{persona}', [AsistenciaController::class, 'historial'])
